...
# ---------------------------------------------
def calculate_cross_sections(E_photon_grid, Trans_E, FC_factors, x, y, z, DO_coeffs_R, DO_coeffs_L, m_max, n_max):
    ...
    for j, E_photon in enumerate(tqdm(E_photon_grid)):
        weights = []
            ...
            for pol in polarizations:
                for m in range(-m_max, m_max + 1):
                    for n in range(0, n_max + 1):
                        psi = build_single_mode_wavefunction_on_xyz_grid(m, n, eKE, a, D, x, y, z, L, L_max=50.0, R_max=50.0)
...
E_photon_grid = np.linspace(1, 5.0, 100)
m_max = 10
n_max = 10
rel_cross_sections = calculate_cross_sections(E_photon_grid, Trans_E, FC_factors, x, y, z, DO_coeffs_R, DO_coeffs_L, m_max, n_max)
