...
DO_coeffs = np.array([0, 0, 0, -7.47775656e-1, 0, 0, 0, 0, 7.47775656e-1, 0])
...
rel_cross_sections = calculate_cross_sections(E_photon_grid, Trans_E, FC_factors, x, y, z, DO_coeffs, L_max=1)
