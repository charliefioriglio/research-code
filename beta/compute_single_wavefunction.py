...
def build_single_mode_wavefunction_on_xyz_grid(m, n, E, a, D, X, Y, Z, L, theta_k, phi_k, L_max=50.0, R_max=50.0, xi_vals=None, eta_vals=None, phi_vals=None):
