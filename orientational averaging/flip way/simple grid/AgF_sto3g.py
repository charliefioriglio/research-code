...
def compute_average_amplitudes(X, Y, Z, DO_coeffs_L, DO_coeffs_R, ang_grid, k_lab, pol_lab):
    ...
    for i in range(N):
        ...
        DO_L = build_DO(DO_coeffs_L, X_rot, Y_rot, Z_rot, R_Ag_rot, R_F_rot)
        DO_R = build_DO(DO_coeffs_R, X_rot, Y_rot, Z_rot, R_Ag_rot, R_F_rot)
...
if __name__ == '__main__':
    ...
    for E in E_eV:
        ...
        # compute amplitudes
        A_par = compute_average_amplitudes(X, Y, Z, DO_coeffs_AgF_L, DO_coeffs_AgF_R, ang_grid, k_par_lab_scaled, pol_lab)
        A_perp1 = compute_average_amplitudes(X, Y, Z, DO_coeffs_AgF_L, DO_coeffs_AgF_R, ang_grid, k_perp1_lab_scaled, pol_lab)
        A_perp2 = compute_average_amplitudes(X, Y, Z, DO_coeffs_AgF_L, DO_coeffs_AgF_R, ang_grid, k_perp2_lab_scaled, pol_lab)
