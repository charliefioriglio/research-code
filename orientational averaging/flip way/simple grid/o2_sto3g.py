...
if __name__ == '__main__':
    ...
    for E in E_eV:
        ...
        A_par = compute_average_amplitudes(X, Y, Z, DO_coeffs_b3g, DO_coeffs_b3g, ang_grid, k_par_lab_scaled, pol_lab)
        deg_A_par = compute_average_amplitudes(X, Y, Z, DO_coeffs_b2g, DO_coeffs_b2g, ang_grid, k_par_lab_scaled, pol_lab)

        A_perp1 = compute_average_amplitudes(X, Y, Z, DO_coeffs_b3g, DO_coeffs_b3g, ang_grid, k_perp1_lab_scaled, pol_lab)
        A_perp2 = compute_average_amplitudes(X, Y, Z, DO_coeffs_b3g, DO_coeffs_b3g, ang_grid, k_perp2_lab_scaled, pol_lab)
        deg_A_perp1 = compute_average_amplitudes(X, Y, Z, DO_coeffs_b2g, DO_coeffs_b2g, ang_grid, k_perp1_lab_scaled, pol_lab)
        deg_A_perp2 = compute_average_amplitudes(X, Y, Z, DO_coeffs_b2g, DO_coeffs_b2g, ang_grid, k_perp2_lab_scaled, pol_lab)
